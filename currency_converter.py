# IF THE PROGRAM IS NOT RUNNING CHECK THE VIDEO ON THE LINK ON LINE 16(below)
...
if k=='live':
    ...
    def every_currency(x,y,z):
        ...
        #from line 42-49 the code is provided by the rapidAPI website to satisfy its input (https://rapidapi.com/natkapral/api/currency-converter5/)
        print("The exchange rate is 1",x,"=",Exchange_rate1,y)
        print()
        a=z*Exchange_rate1
        return round(a,4)
    ...
    print()
    print("The stored exchange rate only contains USD,ETB and GBP currencies. Therefore only choose from the 3.")
    print()
    x=str(input("Currency you want to convert: "))
    print()              
    y=str(input("Currency you want to convert to: "))
...
def main():
    if k=='stored':
        ...
        try:                                                                                        # defensive programming for errors that could result
           ...
           print(z,x,"is",l,y) 
        except (KeyError,NameError,ValueError,ImportError):
